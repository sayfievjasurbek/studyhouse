...
(function () {
  ...
  var D = {
    ...
    "Cr.": ["Kr.", "Кр."],
    "Enter at least one grade to see your estimate.": ["Taxminiy natijani koʻrish uchun kamida bitta baho kiriting.", "Введите хотя бы одну оценку, чтобы увидеть оценочный результат."],
