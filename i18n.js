...
(function () {
  ...
  var D = {
    ...
    "Studying Abroad Has Four Stages. Families Lose Time and Money at Every One.": ["Xorijda oʻqishning toʻrt bosqichi bor. Oilalar har birida vaqt va pul yoʻqotadi.", "У учёбы за границей четыре этапа. Семьи теряют время и деньги на каждом из них."],
    "What happens without support, and what your dedicated Study House advisor does at each stage.": ["Yordamsiz nima boʻladi va Study House shaxsiy maslahatchingiz har bir bosqichda nima qiladi.", "Что происходит без сопровождения и что делает ваш персональный консультант Study House на каждом этапе."],
