...
(function () {
  ...
  var D = {
    ...
    "Start over": ["Boshidan boshlash", "Начать заново"],
    "Continue": ["Davom etish", "Продолжить"],
    "Back": ["Orqaga", "Назад"],
    "Get my result": ["Natijamni olish", "Получить результат"],

    /* Step 1 */
    "Your grades": ["Baholaringiz", "Ваши оценки"],
    "Tell us how your grades are written and where you would like to study.": ["Baholaringiz qanday yozilganini va qayerda oʻqimoqchi ekaningizni ayting.", "Расскажите, в какой системе выставлены ваши оценки и где вы хотели бы учиться."],
    "How do you want to enter your grades?": ["Baholarni qanday kiritmoqchisiz?", "Как вы хотите ввести оценки?"],
    "I know my GPA": ["GPA'imni bilaman", "Я знаю свой GPA"],
    "By subjects (more accurate)": ["Fanlar boʻyicha (aniqroq)", "По предметам (точнее)"],
    "Grading system": ["Baholash tizimi", "Система оценивания"],
    "5-point (Uzbekistan school / lyceum)": ["5 ballik (Oʻzbekiston maktabi / litsey)", "5-балльная (школа / лицей Узбекистана)"],
    "4-point scale (GPA)": ["4 ballik tizim (GPA)", "4-балльная шкала (GPA)"],
    "100-point (university transcript)": ["100 ballik (universitet transkripti)", "100-балльная (университетский транскрипт)"],
    "Percentage (%)": ["Foiz (%)", "Проценты (%)"],
    "Letter grades (A / B / C)": ["Harfli baholar (A / B / C)", "Буквенные оценки (A / B / C)"],
    "International Baccalaureate (Diploma total)": ["Xalqaro bakalavriat (IB diplom jami bali)", "Международный бакалавриат (общий балл диплома)"],
    "A-Level (average grade)": ["A-Level (oʻrtacha baho)", "A-Level (средняя оценка)"],
    ...
    "Your subjects": ["Fanlaringiz", "Ваши предметы"],
    "Overall average across": ["Umumiy oʻrtacha —", "Общее среднее по"],
    ...
    "Choose as many as you like, or none to see everything.": ["Xohlaganingizcha tanlang yoki hammasini koʻrish uchun hech narsa tanlamang.", "Выберите сколько угодно вариантов или ни одного, чтобы увидеть всё."],
    "Enter your average score to continue.": ["Davom etish uchun oʻrtacha ballingizni kiriting.", "Введите средний балл, чтобы продолжить."],
    "Enter at least one subject grade to continue.": ["Davom etish uchun kamida bitta fan bahosini kiriting.", "Введите хотя бы одну оценку по предмету, чтобы продолжить."],
    "On a 4.0 scale the lowest passing grade is a D, which is 1.0. Some German universities use 2.0 instead; the German figure shifts if yours does.": ["4.0 tizimida eng past oʻtish bahosi — D, yaʼni 1.0. Baʼzi nemis universitetlari buning oʻrniga 2.0 dan foydalanadi; sizniki boshqacha boʻlsa, nemis bahosi ham oʻzgaradi.", "На шкале 4.0 низшая проходная оценка — D, то есть 1.0. Некоторые немецкие вузы используют 2.0; если у вас иначе, немецкая оценка сдвинется."],
    "Treated exactly like the 100-point transcript scale, which is how Uzbek universities report percentages.": ["100 ballik transkript tizimi bilan bir xil hisoblanadi — oʻzbek universitetlari foizlarni aynan shunday koʻrsatadi.", "Считается так же, как 100-балльная шкала транскрипта: именно так узбекские вузы указывают проценты."],
    "24 is the minimum total for the IB Diploma and 45 the maximum. There is no official IB-to-GPA conversion, so the calculator shows the German grade and your profile strength but no 4.0 GPA.": ["IB diplomi uchun minimal jami ball — 24, maksimal — 45. IB'ni GPA'ga rasmiy oʻtkazish tizimi yoʻq, shuning uchun kalkulyator nemis bahosi va profil kuchini koʻrsatadi, 4.0 GPA'ni esa yoʻq.", "Минимальный общий балл диплома IB — 24, максимальный — 45. Официального перевода IB в GPA не существует, поэтому калькулятор показывает немецкую оценку и силу профиля, но не GPA по шкале 4.0."],
    "E is the lowest passing A-Level grade. There is no official A-Level-to-GPA conversion, so no 4.0 GPA is shown.": ["E — eng past oʻtish A-Level bahosi. A-Level'ni GPA'ga rasmiy oʻtkazish tizimi yoʻq, shuning uchun 4.0 GPA koʻrsatilmaydi.", "E — низшая проходная оценка A-Level. Официального перевода A-Level в GPA не существует, поэтому GPA по шкале 4.0 не показывается."],

    /* Step 2 */
    "About you": ["Siz haqingizda", "О вас"],
    "Two more things, so the result fits your situation.": ["Natija sizning holatingizga mos boʻlishi uchun yana ikkita savol.", "Ещё два вопроса, чтобы результат соответствовал вашей ситуации."],
    "e.g. Nodira": ["masalan, Nodira", "например, Нодира"],
    "Used on your result card.": ["Natija kartangizda ishlatiladi.", "Используется на карточке результата."],
    "Education level": ["Taʼlim darajasi", "Уровень образования"],
    "School (11 years)": ["Maktab (11 yil)", "Школа (11 лет)"],
    "Lyceum": ["Litsey", "Лицей"],
    "Technical college": ["Kasb-hunar kolleji", "Техникум / колледж"],
    "International school (IB / A-Level)": ["Xalqaro maktab (IB / A-Level)", "Международная школа (IB / A-Level)"],
    "University student (1+ years)": ["Universitet talabasi (1+ yil)", "Студент вуза (1+ год)"],
    "University graduate": ["Universitet bitiruvchisi", "Выпускник вуза"],
    "Pick every test you have taken, then enter the score.": ["Topshirgan barcha imtihonlaringizni belgilang va ballni kiriting.", "Отметьте все сданные экзамены и введите баллы."],
    "No test yet": ["Hali imtihon topshirmaganman", "Экзамена пока нет"],
    "score": ["bali", "балл"],
    "0–9 in half bands": ["0–9, yarim ballik qadam bilan", "0–9 с шагом в половину балла"],
    "0–120": ["0–120", "0–120"],
    "10–160 in 5-point steps": ["10–160, 5 ballik qadam bilan", "10–160 с шагом 5 баллов"],
    "140–190 on the Cambridge English Scale": ["Cambridge English shkalasida 140–190", "140–190 по шкале Cambridge English"],
    "160–210 on the Cambridge English Scale": ["Cambridge English shkalasida 160–210", "160–210 по шкале Cambridge English"],
    "TestDaF TDN 3–5": ["TestDaF TDN 3–5", "TestDaF TDN 3–5"],

    /* Step 3 */
    "Your estimate": ["Sizning taxminiy natijangiz", "Ваша оценка"],
    "No published 4.0 GPA conversion exists for this qualification.": ["Bu malaka uchun 4.0 tizimidagi GPA'ga rasmiy oʻtkazish eʼlon qilinmagan.", "Для этой квалификации нет опубликованного перевода в GPA по шкале 4.0."],
    "Only applies to university-level grades": ["Faqat universitet darajasidagi baholarga taalluqli", "Относится только к оценкам университетского уровня"],
    "One overall average across": ["Umumiy oʻrtacha —", "Общее среднее по"],
    "The German figure uses the modified Bavarian formula": ["Nemis bahosi modifikatsiyalangan Bavariya formulasi boʻyicha hisoblanadi", "Немецкая оценка рассчитана по модифицированной баварской формуле"],
    "Download result card": ["Natija kartasini yuklab olish", "Скачать карточку результата"],
    "Share": ["Ulashish", "Поделиться"],
    "Copied to clipboard": ["Nusxa olindi", "Скопировано в буфер обмена"],
    "Published IELTS minimum": ["Eʼlon qilingan minimal IELTS", "Опубликованный минимум IELTS"],
    "Published TOEFL minimum": ["Eʼlon qilingan minimal TOEFL", "Опубликованный минимум TOEFL"],
    "above your": ["sizdagi balldan yuqori:", "выше вашего:"],
    "We do not have a side-by-side university list for": ["Bizda quyidagi davlat uchun yonma-yon universitetlar roʻyxati yoʻq:", "У нас пока нет таблицы сравнения университетов для:"],
    "yet, so nothing for it is shown below. Ask us in a consultation rather than guessing.": ["— shuning uchun quyida u boʻyicha hech narsa koʻrsatilmaydi. Taxmin qilish oʻrniga konsultatsiyada soʻrang.", "— поэтому ниже по ней ничего не показано. Спросите нас на консультации, а не гадайте."],
    "The grouping below uses only the QS rank held in the country data files, each university's published selectivity and, where a university publishes a minimum English score, how your score compares with it. It is not a prediction of whether you will be admitted — nobody can give you that.": ["Quyidagi guruhlash faqat davlat maʼlumot fayllaridagi QS reytingi, har bir universitetning eʼlon qilingan tanlov qatʼiyligi va, agar universitet minimal ingliz tili balini eʼlon qilgan boʻlsa, sizning balingiz bilan solishtirishga asoslanadi. Bu qabul qilinishingiz haqidagi bashorat emas — buni hech kim ayta olmaydi.", "Группировка ниже опирается только на рейтинг QS из страновых файлов данных, на опубликованную селективность каждого университета и, если вуз публикует минимальный балл по английскому, на сравнение с вашим баллом. Это не прогноз зачисления — его никто дать не может."],
    ...
    "Informatics": ["Informatika", "Информатика"],
    "Subject 1": ["1-fan", "Предмет 1"],
    "Subject 2": ["2-fan", "Предмет 2"],
    "Subject 3": ["3-fan", "Предмет 3"],
    "Subject 4": ["4-fan", "Предмет 4"],
    "Subject 5": ["5-fan", "Предмет 5"],
    "Subject 6": ["6-fan", "Предмет 6"],
    "Subject 7": ["7-fan", "Предмет 7"],
    "Subject 8": ["8-fan", "Предмет 8"],
    "School": ["Maktab", "Школа"],
    "University": ["Universitet", "Университет"],
    "Sources:": ["Manbalar:", "Источники:"],
    "Last updated:": ["Oxirgi yangilanish:", "Последнее обновление:"],
    "25 September 2026": ["2026-yil 25-sentabr", "25 сентября 2026 г."],
    "Turn your Uzbek school or university grades into a 4.0 GPA, an approximate German grade and a UK class band. Every result is an estimate.": ["Oʻzbek maktab yoki universitet baholaringizni 4.0 tizimidagi GPA, taxminiy nemis bahosi va Britaniya daraja toifasiga aylantiring. Har bir natija — taxminiy.", "Переведите свои узбекские школьные или университетские оценки в GPA по шкале 4.0, приблизительную немецкую оценку и британскую категорию диплома. Каждый результат — оценочный."],
    /* ---------- GPA calculator ---------- */
    "Grade scale": ["Baholash tizimi", "Система оценок"],
    "100-point": ["100 ballik", "100-балльная"],
    "5-point": ["5 ballik", "5-балльная"],
    "Quick start": ["Tez boshlash", "Быстрый старт"],
    "Core school subjects": ["Asosiy maktab fanlari", "Основные школьные предметы"],
    "STEM focus": ["STEM yoʻnalishi", "Фокус на STEM"],
    "One semester": ["Bitta semestr", "Один семестр"],
    "Full year": ["Toʻliq oʻquv yili", "Полный учебный год"],
    "Add subject": ["Fan qoʻshish", "Добавить предмет"],
    "Remove subject": ["Fanni oʻchirish", "Удалить предмет"],
    "Subject name": ["Fan nomi", "Название предмета"],
    "Subject": ["Fan", "Предмет"],
    "Grade": ["Baho", "Оценка"],
    "Credits (optional)": ["Kreditlar (ixtiyoriy)", "Кредиты (необязательно)"],
    "Cr.": ["Kr.", "Кр."],
    "German grade (estimate)": ["Nemis bahosi (taxminiy)", "Немецкая оценка (оценочно)"],
    "Below the pass mark for this scale": ["Bu tizimdagi oʻtish balidan past", "Ниже проходного балла этой системы"],
    "1.0 is the best grade": ["1.0 — eng yuqori baho", "1.0 — наивысшая оценка"],
    "UK class (estimate)": ["Britaniya toifasi (taxminiy)", "Британская категория (оценочно)"],
    "Profile strength": ["Profil kuchi", "Сила профиля"],
    "First class": ["Birinchi toifa (First class)", "Первая категория (First class)"],
    "Upper second (2:1)": ["Ikkinchi toifa yuqori (2:1)", "Вторая высшая (2:1)"],
    "Lower second (2:2)": ["Ikkinchi toifa quyi (2:2)", "Вторая низшая (2:2)"],
    "Below a UK 2:2": ["Britaniya 2:2 dan past", "Ниже британской 2:2"],
    "Strong": ["Kuchli", "Сильный"],
    "Medium": ["Oʻrtacha", "Средний"],
    "Needs strengthening": ["Mustahkamlash kerak", "Требует усиления"],
    "Estimate only.": ["Faqat taxminiy.", "Только оценка."],
    "subjects": ["ta fan", "предметам"],
    "Universities and credential-evaluation services apply their own rules.": ["Universitetlar va diplom baholash xizmatlari oʻz qoidalarini qoʻllaydi.", "Университеты и службы оценки дипломов применяют свои собственные правила."],
    "Uzbek 5-point scale": ["Oʻzbek 5 ballik tizimi", "Узбекская 5-балльная система"],
    "Uzbek 100-point scale": ["Oʻzbek 100 ballik tizimi", "Узбекская 100-балльная система"],
    "German": ["Nemis", "Немецкая"],
    "Where this profile sits": ["Bu profil qayerda turadi", "Где находится этот профиль"],
    "The grouping below uses only the QS rank held in the country data files and each university's published selectivity. It is not a prediction of whether you will be admitted — nobody can give you that.": ["Quyidagi guruhlash faqat davlat maʼlumot fayllaridagi QS reytingi va har bir universitetning eʼlon qilingan tanlov qatʼiyligiga asoslanadi. Bu sizning qabul qilinishingiz haqidagi bashorat emas — buni hech kim ayta olmaydi.", "Группировка ниже опирается только на рейтинг QS из страновых файлов данных и на опубликованную селективность каждого университета. Это не прогноз вашего зачисления — его никто дать не может."],
    "Ambitious": ["Ambitsiyali", "Амбициозные"],
    "Realistic": ["Real", "Реалистичные"],
    "Safe": ["Xavfsiz", "Запасные"],
    "Ranked well above the level this profile usually clears — worth one or two applications, with a backup.": ["Bu profil odatda yetadigan darajadan ancha yuqorida — bir-ikkita ariza berishga arziydi, zaxira variant bilan.", "Заметно выше уровня, который обычно проходит такой профиль, — стоит одной-двух заявок при наличии запасного варианта."],
    "In the range where this profile is competitive on the published entry requirements.": ["Eʼlon qilingan qabul talablari boʻyicha bu profil raqobatbardosh boʻlgan oraliqda.", "В диапазоне, где такой профиль конкурентоспособен по опубликованным требованиям к поступлению."],
    "Less selective on the published figures, so more likely to work out — still apply properly.": ["Eʼlon qilingan raqamlarga koʻra kamroq tanlovchan, shuning uchun ehtimoli yuqoriroq — baribir arizani puxta tayyorlang.", "По опубликованным данным менее селективны, поэтому шансы выше — заявку всё равно готовьте как следует."],
    "Nothing in our current country lists falls into this group for this profile. That is a reason to talk to an advisor, not a dead end.": ["Joriy davlat roʻyxatlarimizda bu profil uchun ushbu guruhga tushadigan universitet yoʻq. Bu — boshi berk koʻcha emas, maslahatchi bilan gaplashish uchun sabab.", "В наших текущих страновых списках нет университетов, попадающих в эту группу для такого профиля. Это повод поговорить с консультантом, а не тупик."],
    "The calculator could not be loaded. Please refresh the page.": ["Kalkulyatorni yuklab boʻlmadi. Sahifani yangilang.", "Не удалось загрузить калькулятор. Обновите страницу."],

    /* GPA calculator page copy */
    "How the": ["Hisoblash", "Как работает"],
    "Conversion Works.": ["qanday ishlaydi.", "пересчёт."],
    "4.0 GPA": ["4.0 tizimidagi GPA", "GPA по шкале 4.0"],
    "Each grade is placed in its band on the Uzbek scale — Excellent, Good, Satisfactory — and the band's grade point (4, 3, 2) is averaged, weighted by credits if you enter them. That is how credential-evaluation services read a transcript, so the result is deliberately coarse.": ["Har bir baho oʻzbek tizimidagi oʻz toifasiga joylashtiriladi — aʼlo, yaxshi, qoniqarli — va toifaning bali (4, 3, 2) oʻrtacha hisoblanadi; kreditlar kiritilgan boʻlsa, ular boʻyicha vaznlanadi. Diplom baholash xizmatlari transkriptni aynan shunday oʻqiydi, shuning uchun natija ataylab qoʻpol.", "Каждая оценка относится к своей полосе узбекской системы — отлично, хорошо, удовлетворительно, — и балл этой полосы (4, 3, 2) усредняется, с весом по кредитам, если вы их укажете. Именно так читают транскрипт службы оценки дипломов, поэтому результат намеренно грубый."],
    "German grade": ["Nemis bahosi", "Немецкая оценка"],
    "The modified Bavarian formula, 1 + 3 × (Nmax − Nd) ÷ (Nmax − Nmin), applied to your average raw grade. 1.0 is the best grade and 4.0 is the pass limit. The German universities that publish this formula call the result non-binding orientation only.": ["Modifikatsiyalangan Bavariya formulasi, 1 + 3 × (Nmax − Nd) ÷ (Nmax − Nmin), oʻrtacha xom bahoyingizga qoʻllanadi. 1.0 — eng yuqori baho, 4.0 — oʻtish chegarasi. Bu formulani eʼlon qiladigan nemis universitetlari natijani majburiy emas, faqat dastlabki yoʻnalish deb ataydi.", "Модифицированная баварская формула, 1 + 3 × (Nmax − Nd) ÷ (Nmax − Nmin), применяется к вашей средней исходной оценке. 1.0 — лучшая оценка, 4.0 — порог сдачи. Немецкие вузы, публикующие эту формулу, называют результат необязательным ориентиром."],
    "UK class": ["Britaniya toifasi", "Британская категория"],
    "The GPA ranges the University of Southampton publishes as equivalent to a UK classification: 3.6 and above for a First, 3.2 to 3.6 for a 2:1, 2.8 to 3.2 for a 2:2. Other UK universities set slightly different ranges.": ["Sautgempton universiteti Britaniya toifasiga ekvivalent deb eʼlon qilgan GPA oraliqlari: First uchun 3.6 va undan yuqori, 2:1 uchun 3.2–3.6, 2:2 uchun 2.8–3.2. Boshqa Britaniya universitetlari biroz boshqacha oraliqlar belgilaydi.", "Диапазоны GPA, которые Университет Саутгемптона публикует как эквивалент британской категории: 3.6 и выше для First, 3.2–3.6 для 2:1, 2.8–3.2 для 2:2. Другие британские вузы задают немного иные диапазоны."],
    "This calculator is a planning tool, not an assessment. Only the university you apply to, or an official credential-evaluation service, can tell you what your grades are worth to them. Study House cannot promise admission or a visa.": ["Bu kalkulyator — rejalashtirish vositasi, baholash emas. Baholaringiz ular uchun nimani anglatishini faqat siz ariza beradigan universitet yoki rasmiy diplom baholash xizmati ayta oladi. Study House qabul yoki vizani vaʼda qila olmaydi.", "Этот калькулятор — инструмент планирования, а не оценка. Что ваши оценки значат для них, может сказать только университет, куда вы подаёте, или официальная служба оценки дипломов. Study House не может обещать зачисление или визу."],
    ...
    "Work and Travel in Germany": ["Germaniyada Work and Travel", "Work and Travel в Германии"],
